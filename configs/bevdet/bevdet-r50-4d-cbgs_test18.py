...
_base_ = ['../_base_/datasets/nus-3d.py', '../_base_/default_runtime.py']  # 继承，但我看着第一个nus-3d的基本都重写了
# Global
# If point cloud range is changed, the models should also change their point
# cloud range accordingly
point_cloud_range = [51.2, -51.2, -5.0, 151.2, 51.2, 3.0]  # %%%
...
model = dict(
    ...
    img_backbone=dict(  # MVXTwoStageDetector
        ...
        with_cp=True,
        style='pytorch'),
    img_neck=dict(  # MVXTwoStageDetector
        type='CustomFPN',
        ...
        start_level=0,
        out_ids=[0]),
    img_view_transformer=dict(  # BEVDet
        ...
        downsample=16),
    img_bev_encoder_backbone=dict(  # BEVDet
        type='CustomResNet',
        numC_input=numC_Trans * (len(range(*multi_adj_frame_id_cfg))+1),
        num_channels=[numC_Trans * 2, numC_Trans * 4, numC_Trans * 8]),
    img_bev_encoder_neck=dict(  # BEVDet
        type='FPN_LSS',
        in_channels=numC_Trans * 8 + numC_Trans * 2,
        out_channels=256),
    pre_process=dict(  # BEVDet4D
        type='CustomResNet',
    ...
    pts_bbox_head=dict(  # MVXTwoStageDetector
        type='CenterHead',
        in_channels=256,
        tasks=[
        ...
        bbox_coder=dict(
            ...
            post_center_range=[50, -61.2, -10.0, 150, 61.2, 10.0],  #
            max_num=500,
            score_threshold=0.1,
            out_size_factor=8,
    ...
    test_cfg=dict(
        pts=dict(
            pc_range=point_cloud_range[:2],
            post_center_limit_range=[51.2, -61.2, -10.0, 151.2, 61.2, 10.0],  # %%%
            max_per_img=500,
            max_pool_nms=False,
...
data_root = '/workspace/data/TEST18/'  # %%%
...
bda_aug_conf = dict(
    ...
    scale_lim=(0.95, 1.05),
    flip_dx_ratio=0.5,
    flip_dy_ratio=0.5)  #  BEV-space Data Augmentation
...
test_data_config = dict(
    ...
    ann_file=data_root + 'bevdetv2-nuscenes-test18_infos_val.pkl')  # %%%
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
        data_root=data_root,
        ann_file=data_root + 'bevdetv2-nuscenes-test18_infos_train.pkl',  # %%%
