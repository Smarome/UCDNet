...
data_config = {
    'cams': [
        'CAM_LEFT_id_2', 'CAM_FRONT_id_1', 'CAM_RIGHT_id_1', 'CAM_BACK_id_2', 'CAM_LEFT_id_3',
        'CAM_FRONT_id_3', 'CAM_RIGHT_id_2', 'CAM_BOTTOM_id_2', 'CAM_FRONT_id_2'
    ],
    'Ncams':
    9,
    'input_size': (256, 704),
