...
model = dict(
    ...
    img_bev_encoder_neck=dict(  # BEVDet
        ...
        out_channels=256),
    pre_process=dict(  # BEVDet4D,不知道这是干啥的
        type='CustomResNet',
    ...
    train_cfg=dict(  # 在MVXTwoStageDetector中被加入到pts_bbox_head里
        pts=dict(
...
data_root = '/workspace/data/TEST16/'  # %%%
...
test_data_config = dict(
    ...
    ann_file=data_root + 'bevdetv2-nuscenes-test16_infos_val.pkl')  # %%%
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
        data_root=data_root,
        ann_file=data_root + 'bevdetv2-nuscenes-test16_infos_train.pkl',  # %%%
