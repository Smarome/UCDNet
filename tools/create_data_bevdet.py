...
def add_ann_adj_info(extra_tag):
    ...
    dataroot = '/workspace/data/nuscenes-mini'  # %%%
    nuscenes = NuScenes(nuscenes_version, dataroot)
    for set in ['train', 'val']:
        dataset = pickle.load(
            open('/workspace/data/nuscenes-mini/%s_infos_%s.pkl' % (extra_tag, set), 'rb'))  # %%%
        for id in range(len(dataset['infos'])):
            ...
            dataset['infos'][id]['occ_path'] = \
                '/workspace/data/nuscenes-mini/gts/%s/%s'%(scene['name'], info['token'])  # %%%
        with open('/workspace/data/nuscenes-mini/%s_infos_%s.pkl' % (extra_tag, set),  # %%%
                  'wb') as fid:
...
if __name__ == '__main__':
    ...
    root_path = '/workspace/data/nuscenes-mini'  # %%%
