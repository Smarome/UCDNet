...
def load_gt(nusc: NuScenes, eval_split: str, box_cls, verbose: bool = False) -> EvalBoxes:
    ...
    if eval_split in {'train', 'val', 'train_detect', 'train_track', 'test14_val', 'test14_train','test16_val', 'test16_train','UAV460_train','UAV460_val', 'test17_train', 'test17_val', 'test18_train', 'test18_val', 'test19_train', 'test19_val', 'test20_train', 'test20_val','test21_train', 'test21_val','test23_train', 'test23_val'}:  # %%%%
...
def filter_eval_boxes(nusc: NuScenes,
    ...
    # Change max_dist %%%
    # max_dist = {'barrier': 30, 'bicycle': 40, 'bus': 50, 'car': 50, 'construction_vehicle': 50, 'motorcycle': 40, 'pedestrian': 50, 'traffic_cone': 30, 'trailer': 50, 'truck': 50}
    ...
    for ind, sample_token in enumerate(eval_boxes.sample_tokens):
        ...
        #       eval_boxes.boxes[sample_token] = [box]                                                                            
        #       pdb.set_trace()                           
