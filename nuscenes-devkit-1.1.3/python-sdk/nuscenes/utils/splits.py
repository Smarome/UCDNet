...
UAV460_train = ['scene_0','scene_1','scene_2','scene_3','scene_4','scene_5','scene_6','scene_7','scene_8','scene_9','scene_10','scene_11','scene_12','scene_13','scene_14','scene_15','scene_16','scene_17','scene_18','scene_19','scene_20','scene_21','scene_22','scene_23','scene_24','scene_25','scene_26']
UAV460_val = ['scene_27','scene_28','scene_29','scene_30','scene_31']

test20_val = [
     'scene-1-3', 'scene-1-9', 'scene-2-1', 'scene-2-8', 'scene-3-3', 'scene-3-4', 'scene-4-4', 'scene-4-7',
     'scene-5-6', 'scene-5-2', 'scene-6-3', 'scene-6-9', 'scene-7-9', 'scene-7-10']

test20_train = [
    'scene-1-1', 'scene-1-2', 'scene-1-4', 'scene-1-5', 'scene-1-6', 'scene-1-7', 'scene-1-8', 'scene-1-10',
    'scene-2-2', 'scene-2-3', 'scene-2-4', 'scene-2-5', 'scene-2-6', 'scene-2-7', 'scene-2-9', 'scene-2-10',
    'scene-3-1', 'scene-3-2', 'scene-3-5', 'scene-3-6', 'scene-3-7', 'scene-3-8', 'scene-3-9', 'scene-3-10',
    'scene-4-1', 'scene-4-3', 'scene-4-2', 'scene-4-5', 'scene-4-6', 'scene-4-10', 'scene-4-8', 'scene-4-9',
    'scene-5-1', 'scene-5-9', 'scene-5-3', 'scene-5-4', 'scene-5-5', 'scene-5-8', 'scene-5-7', 'scene-5-10',
    'scene-6-1', 'scene-6-2', 'scene-6-4', 'scene-6-5', 'scene-6-6', 'scene-6-7', 'scene-6-8', 'scene-6-10',
    'scene-7-1', 'scene-7-2', 'scene-7-3', 'scene-7-4', 'scene-7-5', 'scene-7-6', 'scene-7-7', 'scene-7-8'
]

test21_val = [
     'scene-1-3', 'scene-1-9', 'scene-2-1', 'scene-2-8', 'scene-3-3', 'scene-3-4', 'scene-4-4', 'scene-4-7',
     'scene-5-6', 'scene-5-2', 'scene-6-3', 'scene-6-9', 'scene-7-9', 'scene-7-10', 'scene-10-10', 'scene-10-14']

test21_train = [
    'scene-1-1', 'scene-1-2', 'scene-1-4', 'scene-1-5', 'scene-1-6', 'scene-1-7', 'scene-1-8', 'scene-1-10',
    'scene-2-2', 'scene-2-3', 'scene-2-4', 'scene-2-5', 'scene-2-6', 'scene-2-7', 'scene-2-9', 'scene-2-10',
    'scene-3-1', 'scene-3-2', 'scene-3-5', 'scene-3-6', 'scene-3-7', 'scene-3-8', 'scene-3-9', 'scene-3-10',
    'scene-4-1', 'scene-4-2', 'scene-4-3', 'scene-4-5', 'scene-4-6', 'scene-4-8', 'scene-4-9', 'scene-4-10',
    'scene-5-1', 'scene-5-3', 'scene-5-4', 'scene-5-5', 'scene-5-7', 'scene-5-8', 'scene-5-9', 'scene-5-10',
    'scene-6-1', 'scene-6-2', 'scene-6-4', 'scene-6-5', 'scene-6-6', 'scene-6-7', 'scene-6-8', 'scene-6-10',
    'scene-7-1', 'scene-7-2', 'scene-7-3', 'scene-7-4', 'scene-7-5', 'scene-7-6', 'scene-7-7', 'scene-7-8',
    'scene-10-1', 'scene-10-2', 'scene-10-6', 'scene-10-8', 'scene-10-15', 'scene-10-16', 'scene-10-17', 'scene-10-18'
]

test23_val = [
     'scene-1-3', 'scene-1-9', 'scene-2-1', 'scene-2-8', 'scene-3-3', 'scene-3-4', 'scene-4-4', 'scene-4-7',
     'scene-5-6', 'scene-5-2', 'scene-6-3', 'scene-6-9', 'scene-7-9', 'scene-7-10', 'scene-10-9', 'scene-10-10']
...
test23_train = [
    ...
    'scene-6-1', 'scene-6-2', 'scene-6-4', 'scene-6-5', 'scene-6-6', 'scene-6-7', 'scene-6-8', 'scene-6-10',
    'scene-7-1', 'scene-7-2', 'scene-7-3', 'scene-7-4', 'scene-7-5', 'scene-7-6', 'scene-7-7', 'scene-7-8',
    'scene-10-1', 'scene-10-2', 'scene-10-3', 'scene-10-4', 'scene-10-5', 'scene-10-6', 'scene-10-7', 'scene-10-8'
]
...
def create_splits_scenes(verbose: bool = False) -> Dict[str, List[str]]:
    ...
    scene_splits = {'train': train, 'val': val, 'test': test,
                    ...
                    'test14_val': test14_val, 'test14_train': test14_train,
                    'test16_val': test16_val, 'test16_train':test16_train,
                    'UAV460_val': UAV460_val, 'UAV460_train': UAV460_train,
                    'test20_val': test20_val, 'test20_train':test20_train,
                    'test21_val': test21_val, 'test21_train':test21_train,
                    'test23_val': test23_val, 'test23_train':test23_train
                    }  # %%%%%
